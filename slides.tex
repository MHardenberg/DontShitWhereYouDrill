...
\begin{frame}
    \begin{minipage}{.9\columnwidth}
        ...
        \vspace{8pt}
        \captionof{figure}{\it \footnote[frame]size Illustration of soil layers
...
\begin{frame}{Denmark's water}
    ...
    \captionof{figure}{\it \footnotesize Data collected by
    GEUS 2025~\cite{laerke_thorling_groundwater_2025}.}
\end{frame}
...
\begin{frame}{Where do they live?}
    ...
    products\footnote[frame]{\url{https://www.epa.gov/pfas/pfas-explained}}
...
\begin{frame}{PFAS measurements in groundwater wells}
    ...
    \captionof*{figure}{\footnotesize\emph{Red:} PFAS
        chemicals above limit.
