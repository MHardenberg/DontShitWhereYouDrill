...
\begin{frame}
    ...
    \captionof*{figure}{Map of Denmakrs subsurface
    from~\cite{adhikari_soil_2013}}
\end{frame}

\begin{frame}{Denmark's water production}
    \center
    ...
    Abstraction: Amount of water obtained by any method (pumping,
    diverting, etc)
\end{frame}
