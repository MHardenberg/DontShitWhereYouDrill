...
\begin{frame}
    \begin{minipage}{\textwidth}
        \center \includegraphics[width = .8\textwidth]{figures/cheminova.png}
    \end{minipage}

    \begin{minipage}{\textwidth}
        \center \includegraphics[width = .8\textwidth]{figures/landfill.jpg}
    \end{minipage}
\end{frame}
...
\begin{frame}{Where do they live?}
    ...
    Also, in the blood of people and animals, and in food
...
\begin{frame}{PFAS measurements in groundwater wells}
    \centering
    \center \includegraphics[width = .75\textwidth]{figures/pfasdepth.png}

    \captionof*{figure}{\footnotesize\emph{Red:} PFAS chemicals above limit.
        \emph{Blue:} Measured PFAS chemicals. \emph{Grey:} None
    detected~\cite{laerke_thorling_groundwater_2025}.}

    PFAS does not simply break down. They're the eternal chemicals.
\end{frame}
