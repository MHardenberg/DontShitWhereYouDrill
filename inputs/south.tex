...
\begin{frame}{Some numbers~\cite{noauthor_kenya_nodate}}
    \begin{itemize}
        ...
        \item<2-> Total abstraction 7 million m³/year - a thenth of what
            is available. Recharge about 8\% to 9\% of total.

        \item<3-> still aquifers are over abstracted - water level
            decline and quality deterioration.
